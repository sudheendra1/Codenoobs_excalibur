...
class sharemodalsheet extends StatefulWidget{
  const sharemodalsheet({super.key,required this.title,required this.img_url,required this.pdf_url});
  final title;
  final img_url;
  final pdf_url;
  @override
    ...
    return Column(
      children: [
        ...
        Padding(
          ...
          child: Container(
            height: 400,
            child: StreamBuilder(stream: FirebaseFirestore.instance.collection('chat_rooms')
            ...
            return ListView.builder(
                ...
                itemBuilder: (context,index){
                  ...
                  Map<String, dynamic> data = document.data()! as Map<
                      String,
                      dynamic>;
                  return ListTile(title: Text(data['doctor_name']),
                    onTap: ()async{
                      await _share_records.sharerecord(data['IDS'][1],widget.title,data['doctor_name'],data['patient_name'],data['patient_name'],widget.pdf_url,widget.img_url);
