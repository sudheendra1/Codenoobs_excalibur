...
class Share_records extends ChangeNotifier {
  ...
  Future<void> sharerecord(String recieverId, String title, String Docname,
      String patname, String username, String pdfurl, String imageurl) async {
    final String currentuserId = _firebaseAuth.currentUser!.uid;

    Sharing newShare = Sharing(
    ...
    final CollectionReference collection =
        FirebaseFirestore.instance.collection('share_rooms');
