...
class _diagnose_resultState extends State<diagnose_result> {
  ...
  void _record() async {
    final snapshot = await FirebaseFirestore.instance
        ...
        .collection('Predictions')
        .where('disease', isEqualTo: widget.prediction)
        .get();
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                "Disclaimer: This prediction is not supposed to be considered 100% accurate. Don't just follow this prediction, Please also consult a doctor",
